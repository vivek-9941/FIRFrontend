  ...
  return (
    <footer className="bg-gray-900 text-white w-full">
      <div className="w-full px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 text-center max-w-7xl mx-auto">
          <p>&copy; {new Date().getFullYear()} Efir Complaint System. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
